...
- `/api/classrooms/:classroomId/tasks/:classroomTaskId/review-pack`：teacher only；Query: `window, topK, examplesPerTag, includeStudentTiers`；禁止敏感字段，examples 不包含 `codeText/prompt/apiKey`。

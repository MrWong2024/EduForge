...
export const buildSystemPrompt = () => {
  ...
  return [
    ...
    'Do not return empty items for normal submissions; even when mostly correct, return one integrated feedback item with improvements.',
    'Use {"items":[]} only when the submission is not evaluable (for example truly empty or unreadable code).',

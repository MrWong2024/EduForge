...
- AI_FEEDBACK_MAX_ITEMS (default: 20)
  - Compatibility upper bound for provider output. Prompt/protocol layer targets "default 1 item, only when clearly independent allow item 2", provider enforces hard cap `<=2`, and processor compactor remains lightweight fallback.
